...
1. **[Tải file cài đặt tại đây](https://raw.githubusercontent.com/kkitkai/souldrop/main/SoulDrop-Installer.bat)** — nhấn **chuột phải** vào link → chọn **"Save link as..." / "Lưu liên kết thành..."** → lưu ra Desktop.
